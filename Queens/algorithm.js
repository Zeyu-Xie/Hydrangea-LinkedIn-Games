...
*/
const pt_solutions = [];
function _dfs(step, is_boooked, queens) {
    if (step === 9) {
...
const N = pt_solutions.length;
/*
    2. Calculate Solutions
    Define a function `get_solutions`.
*/
function _is_ok(queens, board) {
    const is_boooked = Array(9).fill(false);
    for (let i = 0; i < 9; i++) {
